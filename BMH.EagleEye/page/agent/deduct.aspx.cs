...
{
    public partial class deduct : System.Web.UI.Page
    {
        #region 变量定义        
        ReportAgent rAgent;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                YYLog.ClassLibrary.Log.WriteLog("YYLog.Login:/page/agent/deduct", "账户信息:账户id{0},账户名{1},ip{2}", strAccountId, strAccountName, pageclass.IP.GetIP());
            }
        }
        ...
        public void GetListData(int pageSize, int pageNo, int pageNumber, string adUserId,string sTime,string eTime)
        {
            ...
            DataTable dt = rAgent.GetDeductListDT(pageSize, pageNo, adUserId,sTime,eTime, out dataCount);
