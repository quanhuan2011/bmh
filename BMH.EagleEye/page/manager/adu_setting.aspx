<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adu_setting.aspx.cs" Inherits="BMH.EagleEye.page.manager.adu_setting" %>

<!DOCTYPE html>

<html>
<head>
    <title>鹰眼广告主信息设置</title>
        ...
        <div class="w1230 set-platform" id="YY-main">
            <div class="basic-info">
                ...
                <ul class="info-chpwd">
                    ...
                    <li>
                        <label class="fl">
                            日总投放量上限：</label><input type="text" placeholder="请输入日总投放量上限" id="txtPutMaxByDay" value=<%=putMaxByDay %> /></li>

                    <li>
                        <button  class="btn-confirm button btn_click" id="btnConfirm">修改</button>
        ...
        $("#sltAdu").change(function () {
            ...
            $.ajax({
                ...
                success: function (result) {                    
                    ...
                    $("#txtPutMaxByDay").val(result.data.putmaxbyday);
                }
            });
