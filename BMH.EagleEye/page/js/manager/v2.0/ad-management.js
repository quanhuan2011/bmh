(function () {
    ...
    $(".stop").click(function () {
        ...
        $('.tableBody').find('.cur').each(function () {
            if ($.trim($(this).closest("tr").find(".adstatus").text()) != "1") {
                alert("请选择正确的广告");
                boolStatus = false;
                return false;
            }
            var dataItem = $.trim($(this).parent().parent().find(".adid").text());
    ...
    $(".start").click(function () {
        ...
        var boolStatus = false;
        $('.tableBody').find('.cur').each(function () {
            var adStatus = $.trim($(this).closest("tr").find(".adstatus").text());
            if (adStatus != "2" && adStatus != "0" && adStatus != "-4" && adStatus != "-5" && adStatus != "-6" && adStatus != "-7") {
                alert("请选择正确的广告");
                boolStatus = false;
                return false;
            }
