...
(function () {
    ...
    defaultSettings = {
        dateSettings: {
            // days: ['7', '6', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
            // daysShort: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
            // months: [
            //     'January', 'q', 'March', 'April', 'May', 'June', 'July',
            //     'August', '1', 'October', 'November', 'December'
            // ],
            // monthsShort: ['Ja111n', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
            // meridiem: ['AM', 'PM'],
