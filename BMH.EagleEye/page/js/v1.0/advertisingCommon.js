var bmhAdData = function () {
    ...
    return {
        ...
        wlData: function (dimensionType, startTime, endTime) {
            ...
            var data2;
            var dimensionName;
            var ajaxData1 = { "adlocationid": adLocationId, "starttime": startTime, "endtime": endTime };
            $.ajax({
                type: "post",
                url: "../../api/Report.asmx/GetAdLocationSum",
                data: ajaxData1,
                dataType: "json",
                async: false,
            ...
            var ajaxData2 = { "adlocationid": adLocationId, "starttime": startTime, "endtime": endTime, "dimensiontype": dimensionType };
            $.ajax({
                type: "post",
                url: "../../api/Report.asmx/GetAdLocationList",
                data: ajaxData2,
                dataType: "json",
                async: false,
                success: function (result) {
            ...
            if (dimensionType == "day") {
                for (var i = 0, _length = data2.data.length; i < _length; i++) {
                    tableHtml.push('<td>' + data2.data[i].date + '</td><td>' + data2.data[i].requestcnt + '</td><td>' + data2.data[i].showcnt + '</td><td>' + data2.data[i].clickcnt + '</td><td>' + parseFloat(data2.data[i].ecpm).toFixed(2) + '</td><td>' + parseFloat(data2.data[i].cpc).toFixed(2) + '</td><td>' + data2.data[i].income + '</td><td>' + (data2.data[i].showcnt == "0" ? "0" : (data2.data[i].clickcnt / data2.data[i].showcnt).toPercent()) + '</td><td>' + (data2.data[i].requestcnt == "0" ? "0" : (data2.data[i].showcnt / data2.data[i].requestcnt).toPercent()) + '</td>');
                    tableHtml.push('</tr>');
                }
                for (var i = 0, _length = data2.data.length; i < _length; i++) {
            ...
            if (dimensionType == "area") {
                for (var i = 0, _length = data2.data.length; i < _length; i++) {
                    tableHtml.push('<td>' + data2.data[i].area + '</td><td>' + data2.data[i].requestcnt + '</td><td>' + data2.data[i].showcnt + '</td><td>' + data2.data[i].clickcnt + '</td><td>' + parseFloat(data2.data[i].ecpm).toFixed(2) + '</td><td>' + parseFloat(data2.data[i].cpc).toFixed(2) + '</td><td>' + data2.data[i].income + '</td><td>' + (data2.data[i].showcnt == "0" ? "0" : (data2.data[i].clickcnt / data2.data[i].showcnt).toPercent()) + '</td><td>' + (data2.data[i].requestcnt == "0" ? "0" : (data2.data[i].showcnt / data2.data[i].requestcnt).toPercent()) + '</td>');
                    tableHtml.push('</tr>');
                }
                for (var i = 0, _length = data2.data.length; i < _length; i++) {
            ...
            if (dimensionType == "hour") {
                for (var i = 0, _length = data2.data.length; i < _length; i++) {
                    tableHtml.push('<td>' + data2.data[i].hour + '</td><td>' + data2.data[i].requestcnt + '</td><td>' + data2.data[i].showcnt + '</td><td>' + data2.data[i].clickcnt + '</td><td>' + parseFloat(data2.data[i].ecpm).toFixed(2) + '</td><td>' + parseFloat(data2.data[i].cpc).toFixed(2) + '</td><td>' + data2.data[i].income + '</td><td>' + (data2.data[i].showcnt == "0" ? "0" : (data2.data[i].clickcnt / data2.data[i].showcnt).toPercent()) + '</td><td>' + (data2.data[i].requestcnt == "0" ? "0" : (data2.data[i].showcnt / data2.data[i].requestcnt).toPercent()) + '</td>');
                    tableHtml.push('</tr>');
                }
                for (var i = 0, _length = data2.data.length; i < _length; i++) {
            ...
            if (dimensionType == "class") {
                for (var i = 0, _length = data2.data.length; i < _length; i++) {
                    tableHtml.push('<td>' + data2.data[i].classname + '</td><td>' + data2.data[i].requestcnt + '</td><td>' + data2.data[i].showcnt + '</td><td>' + data2.data[i].clickcnt + '</td><td>' + parseFloat(data2.data[i].ecpm).toFixed(2) + '</td><td>' + parseFloat(data2.data[i].cpc).toFixed(2) + '</td><td>' + data2.data[i].income + '</td><td>' + (data2.data[i].showcnt == "0" ? "0" : (data2.data[i].clickcnt / data2.data[i].showcnt).toPercent()) + '</td><td>' + (data2.data[i].requestcnt == "0" ? "0" : (data2.data[i].showcnt / data2.data[i].requestcnt).toPercent()) + '</td>');
                    tableHtml.push('</tr>');
                }
                for (var i = 0, _length = data2.data.length; i < _length; i++) {
