<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="material_data.aspx.cs" Inherits="BMH.EagleEye.page.report.material_data" %>
...
<div class="bmhAdTop">
    <div class="top-center clearfix">
        <div class="left">
            物料数据表 <span>></span> <a href="#" class="title"><%=materialName %></a>
        </div>
        <div class="right">
    ...
    <div class="bmhAdTable">
        <!-- 数据数字展示 start -->
        <div class="adNum">
            <div class="top"><div class="title">物料数据表</div></div>
            <ul class="clearfix">
                <li>
        ...
        <div class="bmhDataPic clearfix">
            <div class="top clearfix">
                <ul class="tip">
                    <li class="on" name="day">按日</li><li name="hour">按时段</li><li name="class">按分类</li>
                </ul>
...
<!--                             <dd class="ggwqqs">
                                <span class="title" data-color='#08c4c4' data-name="">广告位请求数</span>
        ...
        <div class="datailData TabBox">
            <table class="data-table clearfix" width="100%" cellpadding="0" cellspacing="0" border="0" id="tableNeed">
                <thead>
                    <tr>
                        <th>时间</th><th>展现量</th><th>点击量</th><th>点击率</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script>
    ...
    <script src="../js/report/v2.0/wlCommon.js" type="text/javascript"></script>
