<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ad_data.aspx.cs" Inherits="BMH.EagleEye.page.report.ad_data" %>
...
<div class="bmhAdTop">
    <div class="top-center clearfix">
        <div class="left">
            广告数据表 <span>></span> <a href="#" class="title"><%=adName %></a>
        </div>
        <div class="right">
    ...
    <div class="bmhAdTable">
        <!-- 数据数字展示 start -->
        <div class="adNum">
            <div class="top"><div class="title">广告数据表</div></div>
            <ul class="clearfix">
                <li>
        ...
        <div class="bmhDataPic clearfix">
            <div class="top clearfix">
                ...
                <div class="choice fr" style="position:relative">
                    <div class="box clearfix chart_title">
                        <dl class="fl">
                            <!-- <dd class="ggwqqs">广告位请求数</dd> -->
                            <dd class="zxl">展现量</dd><dd class="djliang">点击量</dd>
                        </dl>
                    ...
                    <div class="slide chart_slt">
                        <dl>
                            ...
                            <dd class="djliang">
                                ...
                                <div class="checkbox-con">
                                    <span>
                                    <input type="checkbox"  class="ipt-hide" name="apk[]" value='点击量' checked>
                                        <label class="checkbox cur"></label>
                                   </span>
                                </div>
                            </dd>
...
<script>
    var adId = '<%=adId %>';
    var bType = '<%=billingType %>';
    if (bType == "2")
    {
        $(".adNum ul li").eq(1).find("p").text("下载量");
        $(".adNum ul li").eq(2).find("p").text("下载率");
        $(".chart_title .djliang").text("下载量");
        $(".chart_slt .djliang .title").text("下载量");
        $(".chart_slt .cpc .title").text("cpd");
        $(".chart_slt .djl .title").text("下载率");
    }
 var _dimensionType = "day", _starttime, _endtime;
    ...
    <script src="../js/report/v2.0/adComon.js" type="text/javascript"></script>
